        ...
        <Nav class="ms-auto me-2">
            <Dropdown class="me-2">
                ...
                <DropdownMenu end>
                    ...
                    <DropdownItem href="/articles">Статьи</DropdownItem>
                </DropdownMenu>
            </Dropdown>
            {#if !$isAuth}
            <Dropdown class="me-2">
            ...
            <Dropdown class="me-2">
                ...
                <DropdownMenu end>
                    ...
                    <DropdownItem href="/profile/tasks">Список моих задач</DropdownItem>
                    <DropdownItem href="/profile/createarticle">Создать статью</DropdownItem>
